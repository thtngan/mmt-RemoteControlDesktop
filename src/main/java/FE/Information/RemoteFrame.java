...
public class RemoteFrame extends JFrame implements Runnable {
  ...
  public RemoteFrame(ClientPanel client_panel, CommonBus common_bus, String quality) throws Exception {
    this.setTitle("You are remoting " + common_bus.getTcpClient().getClient().getInetAddress().getHostName());
  ...
  private void initComponents() throws RemoteException {
    ...
    // TODO: style menu
    this.menu_monitor.setText("REMOTE COMPUTER CONTROL FUNCTIONS");
